...
# Chrome cannot safely use the same profile from two simultaneous instances.
# Close only Chrome processes using this Taobao operation profile.
...
[pscustomobject]@{
    ...
    Proxy = "disabled for this Chrome instance"
